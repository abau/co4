...
(trsAck, allocatorAck) = 
  let a a1 a2 = Node (nat 0) (Conss a1 (Conss a2 Nill))
      s s1    = Node (nat 1) (Conss s1 Nill)
      n       = Node (nat 2) Nill
      x       = Var  (nat 0)
      y       = Var  (nat 1)
...
(trsF, allocatorF) = 
  let t  a b = Node (nat 0) (Conss a (Conss b Nill))
      p  a b = Node (nat 1) (Conss a (Conss b Nill))
      f  a   = Node (nat 2) (Conss a Nill)
      g  a b = Node (nat 3) (Conss a (Conss b Nill))
      a      = Node (nat 4) Nill
      x      = Var  (nat 0)
      y      = Var  (nat 1)
      z      = Var  (nat 2)
...
(trsFSL, allocatorFSL) = 
  let t1 a b = Node (nat 0) (Conss a (Conss b Nill))
      t2 a b = Node (nat 1) (Conss a (Conss b Nill))
      p  a b = Node (nat 2) (Conss a (Conss b Nill))
      f  a   = Node (nat 3) (Conss a Nill)
      g  a b = Node (nat 4) (Conss a (Conss b Nill))
      a      = Node (nat 5) Nill
      x      = Var  (nat 0)
      y      = Var  (nat 1)
      z      = Var  (nat 2)
...
(trsCF, allocatorCF) = 
  let f a = Node (nat 0) (Conss a Nill)
      s a = Node (nat 1) (Conss a Nill)
      g a = Node (nat 2) (Conss a Nill)
      x   = Var  (nat 0)
